...
import './EngagementByPlatform.css';
...
const EngagementByPlatform = ({ data }) => {
  ...
  return (
    <div className="chart-card engagement-by-platform">
...
EngagementByPlatform.propTypes = {
...
export default EngagementByPlatform; 