...
const SUPABASE_URL = import.meta.env.VITE_SUPABASE_URL || "https://uojpdnzjinmbpamxtxco.supabase.co";
const SUPABASE_ANON_KEY = import.meta.env.VITE_SUPABASE_ANON_KEY || "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVvanBkbnpqaW5tYnBhbXh0eGNvIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTE1Mzc3NDMsImV4cCI6MjA2NzExMzc0M30.OxaBUldXCqcSEH2-1kgr0A4ASZ4D7rYY8rhjHnIyMd4";
...
export const getListCounts = async () => {
  try {
    ...
    return { selected: 0, rejected: 0, suggested: 0 };
  }
};
