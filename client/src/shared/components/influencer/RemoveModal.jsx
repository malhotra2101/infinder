...
const RemoveModal = ({ isOpen, onClose, onRemove, influencer }) => {
  ...
  const fetchInfluencerCampaigns = async () => {
    try {
      ...
      const response = await fetch(`${API_CONFIG.BASE_URL}/api/influencers/${influencer.id}/campaigns`);
  ...
  const handleRemove = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_CONFIG.BASE_URL}/api/influencers/lists/remove-campaigns`, {
        method: 'POST',
        headers: {
